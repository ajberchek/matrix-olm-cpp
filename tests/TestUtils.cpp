...
TEST(TestUtils, VerifyThisSigned) {
    auto one_time_key =
        json::parse("{\"key\": \"IxuXdZW1SVN9AsrBjrskj17gKessBnMm+7yvAOwgdG8\",\"signatures\": "
                    "{\"Zaphod\": {\"ed25519:HeartOfGold\": "
                    "\"JN23hpj5AeR9RLbQu2d4N59oHMQWWnotDL62eWCcDJhVc7HWHul3fnc920WAFzw20SevxterUzuj"
                    "NuInHYsTAA\"}}}");
    string signing_key = "mwdvZBT+4IIJtcjdIBefvi13hfmPcAtF1HzhyucAt4o";
    ASSERT_TRUE(verify(one_time_key, signing_key));
}
TEST(TestUtils, VerifyBadSigFails) {
    auto one_time_key =
        json::parse("{\"key\": \"IxuXdZW1SVN9AsrBjrskj17gKessBnMm+7yvAOwgdG8\",\"signatures\": "
                    "{\"Zaphod\": {\"ed25519:HeartOfGold\": "
                    "\"JN23hpj5AeR9RLbQu2d4N59oHMQWWnotDL62eWCcDJhVc7HWHul3fnc920WAFzw20SevxterUzuj"
                    "NuInHYsTAA\"}}}");
    string signing_key = "lEuiRJBit0IG6nUf5pUzWTUEsRVVe/HJkoKuEww9ULI";
    ASSERT_TRUE(!verify(one_time_key, signing_key));
}
